...
# MAGIC
# MAGIC <img src='https://github.com/komae5519pv/dbx_learning/blob/main/demand_forecast_20241013/01_e2e_demand_forecast/_image_for_notebook/workflows.png?raw=true' width='90%'/>
...
# MAGIC <img src='https://github.com/komae5519pv/dbx_learning/blob/main/demand_forecast_20241013/01_e2e_demand_forecast/_image_for_notebook/01_config.png?raw=true' width='90%'/>
# MAGIC
# MAGIC
# MAGIC #### 3. パイプライン（旧 Delta Live Tables）作成
# MAGIC - General
...
# MAGIC <img src='https://github.com/komae5519pv/dbx_learning/blob/main/demand_forecast_20241013/01_e2e_demand_forecast/_image_for_notebook/pipeline_setting.png?raw=true' width='90%'/>
# MAGIC
# MAGIC
# MAGIC #### 4. ワークフロー作成
...
# MAGIC <img src='https://github.com/komae5519pv/dbx_learning/blob/main/demand_forecast_20241013/01_e2e_demand_forecast/_image_for_notebook/workflow_setting.png?raw=true' width='90%'/>
# MAGIC
# MAGIC #### 5. ワークフロー実行開始
# MAGIC - 3まででワークフロー作成完了です。画面右上「今すぐ実行」をクリックしてください
# MAGIC <img src='https://github.com/komae5519pv/dbx_learning/blob/main/demand_forecast_20241013/01_e2e_demand_forecast/_image_for_notebook/workflow_run.png?raw=true' width='90%'/>
