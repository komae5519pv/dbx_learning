...
# MAGIC <img src='https://github.com/komae5519pv/dbx_learning/blob/main/demand_forecast_20241013/01_e2e_demand_forecast/_image_for_notebook/step1_get_cluster_json.png?raw=true' width='90%'/>
# MAGIC <img src='https://github.com/komae5519pv/dbx_learning/blob/main/demand_forecast_20241013/01_e2e_demand_forecast/_image_for_notebook/step2_copy_cluster_id.png?raw=true' width='90%'/>
...
# MAGIC <img src='https://github.com/komae5519pv/dbx_learning/blob/main/demand_forecast_20241013/01_e2e_demand_forecast/_image_for_notebook/pipeline_id.png?raw=true' width='90%'/>
...
# MAGIC <img src='https://github.com/komae5519pv/dbx_learning/blob/main/demand_forecast_20241013/01_e2e_demand_forecast/_image_for_notebook/step3_copy_yaml.png?raw=true' width='90%'/>
# MAGIC
# MAGIC step2. ワークフロー -> 作成 -> ジョブ -> Yamlとして編集
# MAGIC <img src='https://github.com/komae5519pv/dbx_learning/blob/main/demand_forecast_20241013/01_e2e_demand_forecast/_image_for_notebook/step4_create_new_job.png?raw=true' width='90%'/>
# MAGIC
# MAGIC step3. ワークフロー -> 作成 -> ジョブ -> Yamlとして編集
# MAGIC <img src='https://github.com/komae5519pv/dbx_learning/blob/main/demand_forecast_20241013/01_e2e_demand_forecast/_image_for_notebook/step5_edit_yaml.png?raw=true' width='90%'/>
# MAGIC
# MAGIC step4. 先ほどコピーした`workflows.yaml`ファイルの中身を貼り付けて保存してください
# MAGIC <img src='https://github.com/komae5519pv/dbx_learning/blob/main/demand_forecast_20241013/01_e2e_demand_forecast/_image_for_notebook/step6_overwrite_yaml.png?raw=true' width='90%'/>
# MAGIC
# MAGIC step5. これでワークフローの設定が完了です
# MAGIC <img src='https://github.com/komae5519pv/dbx_learning/blob/main/demand_forecast_20241013/01_e2e_demand_forecast/_image_for_notebook/step7_complete_workflows_setting.png?raw=true' width='90%'/>
