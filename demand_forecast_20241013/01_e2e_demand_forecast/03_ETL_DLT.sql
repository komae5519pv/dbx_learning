...
-- MAGIC
-- MAGIC <img src='https://github.com/komae5519pv/dbx_learning/blob/main/demand_forecast_20241013/01_e2e_demand_forecast/_image_for_notebook/01.%20DLT_Pipeline.png?raw=true' width='90%'/>
-- MAGIC
-- MAGIC 想定のディレクトリ構成
-- MAGIC
-- MAGIC ```
